...
const verifyQuantityString = (string) => {
  return string.length
}

console.log(verifyQuantityString('Kened'))
/*
  03
...
*/
const returnIndex = (char, string) => {
  const index = string.indexOf(char)
  return index
}

console.log(returnIndex('d', 'Kened'))
/*
  05
...
const isExistsInArray = (char, array) => {
  const verified = array.includes(char)

  return verified;
}
console.log(isExistsInArray('kene', ['maria', 'joao', 'kened']))
/*
  06
