...
*/
cat.age += 2
console.log('A idade do gato + 2 é: ', cat.age)
/*
  04
...
let dog = {
  ...
  age:9,
  color:'marrom',
  bestFriends: ["Biriba", "Larry"],
  sound:function(){ return 'auau'}
}
...
const isAnSUV = car => {
  isSUV = car === 'Honda HR-V' || car === 'Jeep Renegade' || car === 'Ford EcoSport' || car === 'Hyundai iX35'
  if (isSUV) {
    return true
  }
...
console.log(verifyTypes('null'))
console.log(verifyTypes('object'))
console.log(verifyTypes('undefined'))