...
function mutiplyNumbers(numberOne = 0 , numberTwo = 0){
  return numberOne * numberTwo
}

console.log(mutiplyNumbers(2, 2))
/*
  02
  ...
  - Faça o mesmo que o exercício acima pede, mas desta vez, implemente uma  
    **function expression** que retorne o resultado da **divisão** entre esses  
    2 números.
*/
const divideNumbers = function (numberOne = 0, numberTwo = 0) {
  return numberOne / numberTwo
}
...
*/
const printString = function (string = "Padrão"){
  for(let i =1; i < 8; i++){
...
const convertToUpperCase = function (array = []){
  ...
  for(let i = 0; i < array.length; i++){
    ...
    arrayConverted.push(wordInUppercase)
  }
...
const isPositive = function(array = []){
  countPositive = 0
  countNegative = 0
  for(let i =0; i < array.length; i++){
    if(array[i] > 0){
...
console.log(isPositive(randomNumbers))
